...
public class MZ_list_p2_F {
	...
	private void list_P2() {
		...
		btn_home.setIcon(new ImageIcon(MZ_list_p2_F.class.getResource("/mz/mzImg/home.png")));
...
////                MZ_menu_p3.MZ_menu_p3();
				MZ_tbl.num=1;
					...
					up.update("update f_mz_tbl set mz_hit=(mz_hit+1) where mz_uid = "+ MZ_tbl.num + ";");
